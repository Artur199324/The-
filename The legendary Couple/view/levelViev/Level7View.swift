...
struct Level7View: View {
    ...
    @State private var buttonStates: [Bool] = Array(repeating: false, count: 22) // Изменено на 22 для 22 кнопок
    ...
    private var images: [String] = ["el_01", "el_01", "el_02", "el_02", "el_03", "el_03", "el_04", "el_04", "el_05", "el_05", "el_06", "el_06", "el_07", "el_07", "el_08", "el_08", "el_09", "el_09", "el_10", "el_10", "el_11", "el_11"].shuffled() // Изменено на 22 элемента
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                // Один ряд сверху с одной кнопкой
                HStack {
                    Spacer()
                    gameButton(at: 0)
                    Spacer()
                ...
                // Один ряд снизу с одной кнопкой
                HStack {
                    Spacer()
                    gameButton(at: 21)
                    Spacer()
