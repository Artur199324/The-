...
struct Level2View: View {
    ...
    private var images: [String] = ["el_01", "el_01", "el_02", "el_02", "el_03", "el_03", "el_04", "el_04", "el_05", "el_05", "el_06", "el_06"].shuffled()
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack(spacing: 10) {
                    ...
                    // Четвертая строка с отступами по бокам и 3 кнопками
                    HStack(spacing: 10) {
                        Spacer()
                        gameButton(at: 9)
                        Spacer()
