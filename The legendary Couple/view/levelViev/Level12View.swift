...
struct Level12View: View {
    ...
    @State private var buttonStates: [Bool] = Array(repeating: false, count: 28) // Изменено на 28 для 28 кнопок
    ...
    private var images: [String] = ["el_01", "el_01", "el_02", "el_02", "el_03", "el_03", "el_04", "el_04", "el_05", "el_05", "el_06", "el_06", "el_07", "el_07", "el_08", "el_08", "el_09", "el_09", "el_10", "el_10", "el_11", "el_11", "el_12", "el_12", "el_13", "el_13", "el_14", "el_14"].shuffled() // Изменено на 28 элементов
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                // Второй ряд с четырьмя кнопками
                HStack(spacing: 10) {
                    Spacer()
                    gameButton(at: 5)
                    gameButton(at: 6)
