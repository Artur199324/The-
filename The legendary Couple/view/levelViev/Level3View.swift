...
struct Level3View: View {
    ...
    @State private var buttonStates: [Bool] = Array(repeating: false, count: 14) // Изменено на 14 для 14 кнопок
    ...
    private var images: [String] = ["el_01", "el_01", "el_02", "el_02", "el_03", "el_03", "el_04", "el_04", "el_05", "el_05", "el_06", "el_06", "el_07", "el_07"].shuffled() // Изменено на 14 элементов
