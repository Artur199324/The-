...
struct Level5View: View {
    ...
    @State private var buttonStates: [Bool] = Array(repeating: false, count: 18) 
    ...
    private var images: [String] = ["el_01", "el_01", "el_02", "el_02", "el_03", "el_03", "el_04", "el_04", "el_05", "el_05", "el_06", "el_06", "el_07", "el_07", "el_08", "el_08", "el_09", "el_09"].shuffled() // Изменено на 18 элементов
