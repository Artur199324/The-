...
struct Level16View: View {
    ...
    @State private var buttonStates: [Bool] = Array(repeating: false, count: 20) // Изменено на 20 для 20 кнопок
    ...
    private var images: [String] = ["el_01", "el_01", "el_02", "el_02", "el_03", "el_03", "el_04", "el_04", "el_05", "el_05", "el_06", "el_06", "el_07", "el_07", "el_08", "el_08", "el_09", "el_09", "el_10", "el_10"].shuffled() // Изменено на 20 элементов
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                // Последний ряд с тремя кнопками
                HStack(spacing: 10) {
                    Spacer()
                    gameButton(at: 17)
                    Spacer()
